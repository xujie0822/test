...
class Perceptron(object):
    ...
    def predict(self, input_vec):
        ...
        :return:
        """
        return self.activator(reduce(lambda a, b: a+b, map(lambda x_w: x_w[1] * x_w[0], zip(input_vec, self.weights)), 0.0) + self.bias)

    def train(self, input_vecs, labels, iteration, rate):
        """
        输入训练数据：一组向量与每个向量对应的label，训练次数，学习速率
        :param input_vecs:
        :param labels:
        :param iteration:
        :param rate:
